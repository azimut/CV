...
\begin{tabular}{@{}rll@{}}
  \hspace{.1em} \textbf{programming} & common lisp, bash, go, awk, jq, elm \\
  \hspace{.1em} \textbf{tools}       & emacs, git, docker, ansible, github actions \\
  \hspace{.1em} \textbf{databases}   & sqlite, postgres \\
