...
\newcommand
    {\pproject}
    [3]
    {\texttt{#1} & #3 \git{\scriptsize{\faLink}}{#2}\\}
...
\begin{center}
  \begin{tabular}{c l}
    \pproject{Common Lisp} {scenic}         {several game engines and midi sequencers}
    \pproject{Golang}      {cli-view}       {command line clients to view comments of different websites}
    \pproject{Elm}         {newspod}        {fully searchable database of tech podcasts}
    \pproject{Erlang}      {snitch}         {monitor of public dns records}
    \pproject{Typescript}  {reddit-gallery} {reddit image gallery made with React}
  \end{tabular}
\end{center}
