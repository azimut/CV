...
\begin{itemize}
\item Network design and deploy of a \texttt{OpenVPN} node and a \texttt{Squid} proxy. Maintenance and technical support.
\end{itemize}
...
\hypersetup{
  pdftitle = {{\FULLNAME}, Backend Software Engineer},
  urlcolor = gray
}
\begin{center}
  \begin{tabular}{ c l }
    ...
    \project{Elm}         {newspod}        {web search engine of tech podcasts}
