...
\begin{itemize}
  \setlength{\parskip}{0pt}
  \setlength{\itemsep}{0pt plus 1pt}
  \item[--] Build \git{several}{shiny} \git{game}{incandescent} \git{engines}{scenic}, based on OpenGL
  \item[--] Wrote wrappers for \git{multiple}{cl-gme} \git{3rd}{espeak-ng} \git{party}{aubio} \git{C}{cloud} libraries
  \item[--] Created multiple \git{audio}{meniere}, \git{video}{viseq} and \git{midi}{launchpad-csound} sequencers
\end{itemize}
...
\begin{itemize}
  \setlength{\parskip}{0pt}
  \setlength{\itemsep}{0pt plus 1pt}
  \item[--] A Portage \git{overlay}{overlay} repository, to build software within Gentoo systems.
